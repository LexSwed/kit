...
type LexicalComposerContextWithEditor = [LexicalEditor, LexicalComposerContextType];
...
const LexicalComposerContext = createContext<LexicalComposerContextWithEditor | null | undefined>(null);

const useLexicalComposerContext = (): LexicalComposerContextWithEditor => {
